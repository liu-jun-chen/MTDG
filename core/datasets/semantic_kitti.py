...
label_name_mapping = {
    ...
    20: 'other-vehicle',
    30: 'person',
    31: 'rider',  # add 'rider' class and map 'bicyclist' to 'rider'
    32: 'rider',  # map 'motorcyclist' to 'rider'
    40: 'road',
    44: 'parking',
    48: 'sidewalk',
    49: 'other-ground',
...
kept_labels = [
    'other-ground', 'building', 'car',
    'bicycle', 'vegetation', 'trunk',
    'person', 'rider', 'fence', 'pole', 'traffic-sign'
]
        ...
        for label_id in label_name_mapping:
            if label_id > 250:
                ...
                if label_name_mapping[label_id] in kept_labels:
                    if label_name_mapping[label_id] not in seen_labels:
                        self.label_map[label_id] = cnt
                        reverse_label_name_mapping[
                            label_name_mapping[label_id]] = cnt
                        cnt += 1
                        seen_labels.add(label_name_mapping[label_id])
                    else:
                        self.label_map[label_id] = cnt - 1 
                        reverse_label_name_mapping[
                            label_name_mapping[label_id]] = cnt - 1
                else:
                    self.label_map[label_id] = 255
